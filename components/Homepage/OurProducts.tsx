...
const ProductExplorer = () => {
  ...
  const images = ['/chart.svg', '/cashout.svg','/idcard.svg','/dashboard.svg'];
  ...
  return (
    <div className="relative w-full bg-left-bottom bg-no-repeat" style={{backgroundImage:'url(/products_bg.svg)'}}>
      <div className="container py-20 px-4 mx-auto">
        <div className="flex flex-col items-center justify-center">
          <div className="md:w-[100%] md:mx-auto lg:mx-auto lg:w-[80%]">
            <div>
              ...
              <div>
                ...
                >
                  <button
                    ...
                    className={`whitespace-nowrap px-3 py-1 text-sm font-medium ring-offset-background focus-visible:outline-none rounded-3xl ${
                      activeTab === 0
                  ...
                  <button
                    ...
                    className={`whitespace-nowrap px-3 py-1 text-sm font-medium focus-visible:outline-none rounded-3xl ${
                      activeTab === 1
                        ? 'shadow border'
                        : 'transition-all'
                    } hover:bg-gray-200`}
                ...
                {activeTab === 0 && (
                  ...
                  >
                    <div className="rounded-xl z-50 border shadow my-4 grid md:grid-cols-2">
