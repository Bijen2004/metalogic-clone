...
const Metalogic = () => {
  return (
    <div className='min-h-screen bg-black relative flex items-center justify-center' style={{ backgroundImage: "url('/herobg.svg')" }}>
        <div className='bg-[rgba(37,58,120,0.5)]  w-[96%] lg:w-[70%] md:w-[93%] rounded-xl border text-white'>
            <div className='p-[32px]'>
                ...
                <path id="dots" d="M30 32L30 383" stroke="#999999" strokeWidth="2" strokeLinecap="round" />
